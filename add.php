...
<body>
    <main>
        ...
        <a href="add.php" class="btn" style="margin-top: 20px; margin-left:80px; margin-bottom: 20px; background-color: yellow"><i class="fas fa-user-plus"></i> Thêm tên thuốc</a>

        <table class="table table-striped" style="margin-top: 20px; margin-left:80px; max-width: 88%; background-color: success ">
            <thead>
                <tr>
